// Canvas setup and common functions
...
function getColor(iterations, maxIterations) {
    if (iterations === maxIterations) return [0, 0, 0]; // Black for the set
    
    // A simple colormap based on iteration count
...
// Initialize and draw fractals when the page loads
window.onload = function() {
    ...
    // Add interactivity for Julia set
    const juliaParamDisplay = document.getElementById('julia-param');
    
    // Update Julia set based on Mandelbrot canvas clicks
    ...
    document.getElementById('iterations-slider').addEventListener('input', function() {
        ...
        // Redraw both fractals with new iterations
